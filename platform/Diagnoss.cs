...
public partial class Platform
{
    ...
    */
    ...
    public async Task<dynamic> DiagnossByteAsync(short number = 0, short axis = 0)
    {
        return await Task.FromResult(Diagnoss(number, axis));
    }

    public async Task<dynamic> DiagnossWordAsync(short number = 0, short axis = 0)
    {
        return await Task.FromResult(Diagnoss(number, axis, 4 + 2 * 1));
    }

    public async Task<dynamic> DiagnossDoubleWordAsync(short number = 0, short axis = 0)
    {
        return await Task.FromResult(Diagnoss(number, axis, 4 + 4 * 1));
    }

    public async Task<dynamic> DiagnossByteFirstAxisAsync(short number = 0)
    {
        return await Task.FromResult(Diagnoss(number, 1));
    }

    public async Task<dynamic> DiagnossWordFirstAxisAsync(short number = 0)
    {
        return await Task.FromResult(Diagnoss(number, 1, 4 + 2 * 1));
    }

    public async Task<dynamic> DiagnossDoubleWordFirstAxisAsync(short number = 0)
    {
        return await Task.FromResult(Diagnoss(number, 1, 4 + 4 * 1));
    }

    public async Task<dynamic> DiagnossRealFirstAxisAsync(short number = 0)
    {
        return await Task.FromResult(Diagnoss(number, 1, 4 + 8 * 1));
    }
